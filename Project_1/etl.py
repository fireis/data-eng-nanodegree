...
def process_song_file(cur, filepath):
    """Reads and processes song files

    Parameters:
    cur (cursor): active cursor for the db
...
def process_log_file(cur, filepath):
    ...
    for index, row in df.iterrows():
        ...
        time = pd.to_datetime(row['ts'], unit='ms').time()
...
def process_data(cur, conn, filepath, func):
    ...
    filepath (str): path to files (or paths)
    func (function): function to be used with the files
